## The below functions all you to create a matrix object with getter and setter methods for the
## matrix value and inverse value. They also allow you to cache the matrix inverse for later use. 
